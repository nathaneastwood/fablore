...
def create_md_file(file: str, sort: str):
    ...
    m = markdown_table(df.to_dict(orient="records")).set_params(row_sep="markdown", quote=False).get_markdown()
...
create_md_file("./src/data/fauna.csv", "Name")
create_md_file("./src/data/flora.csv", "Name")
...
create_md_file("./src/data/monsters.csv", "Name")
