...
db.update_description(
    "location", "Aui's Scale Strongholds", "Locations where things are concealed from the public.",
)
...
db.update_description(
    "location", "Demonastery",
    "Mansion with specific rooms per resident; it moves, accessible by invitation.",
)
db.update_description(
    "location", "Eighth Precinct", "Enforcer station, down the street from the Iron Hall.",
)
db.update_description(
    "location", "Enion", "Armory of the ancients and training ground of champions.",
)
db.update_description(
...
db.update_description(
    "location", "Forward Camps", "Home to merchants, traders, adventurers, and mercenaries.",
)
db.update_description("location", "Fractal Scar", "Site of the Battle of Fractal Scar.")
db.update_description(
    "location", "Freakshow Territory", "Deep in the Pits, composed of abandoned mineshafts.",
)
...
db.update_description(
    "location", "Iron Hall", "The seat of power for Metrix's municipal government.",
)
db.update_description("location", "Ironsong Forge", "In the city proper.")
db.update_description(
    "location", "Jawbreaker Territory",
...
db.update_description(
    "location", "Library of Illumination",
...
db.update_description(
    "location", "Numbskull Territory", "Cave network lined with skulls, resembling a catacomb.",
)
...
db.update_description("location", "Solana", "City.")
db.update_description("location", "Sori 16", "Location of The Leaf House.")
db.update_description("location", "Southmaw", "Southmaw Asylum is a laboratory of horrors where the orphaned and discarded of the Pits beneath Metrix are subjected to nightmarish experiments.")
...
db.update_description(
    "location", "Yvor's Peak", "Statue of Yvor located here, doorway to an armory.",
)
db.update_description(
    "location", "i'Arathael",
