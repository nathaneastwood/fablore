...
THE_BLEAKE_EXPANSE = LocationEntry("The Bleake Expanse", region="Aria")
...
GRAYSTONE_PENITENTIARY = LocationEntry("Graystone Penitentiary", region="High Seas")
...
LUNAR_TEMPLE = LocationEntry("Lunar Temple", region="Misteria")
