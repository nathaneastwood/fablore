...
"The [light of Sol](../continents/rathe/solana/the-order-of-the-light.md) will dispel the darkness, and guide us unto the path of righteousness."
...
To master the [Art of the Sparrow](../continents/rathe/misteria/the-seven-arts.md#sparrow) is to master one's own body, and possess the agility of a bird in flight.
...
A warrior of the [Hand of Sol](../continents/rathe/solana/the-order-of-the-light.md) is trained to turn the enemies' advances to his advantage.
...
The [Magister](../continents/rathe/solana/the-order-of-the-light.md#magisters)'s voice filled the departure halls, as the [blessing of Sol](../continents/rathe/solana/a-radiant-city.md#the-blessing-of-sol) washed over them.

#### Wounded Bull - (WTR200)
In the [Savage Lands](../continents/rathe/savage-lands/savage-lands.md), humans, like animals, are more dangerous when they bleed.
