...
Fang stepped through into a massive converted underground cavern. To one side, a legion of soldiers trained. On the other, the Sayashi pored over reports from across [Volcor](../../regions/rathe/volcor/volcor.md). An imposing woman moved among the Sayashi, checking scrolls of intelligence here, whispering instructions there. He recognized her by reputation more than familiarity. [Cindra](../../heroes-of-rathe/cindra-about.md), the fearsome Dracai of Retribution.
