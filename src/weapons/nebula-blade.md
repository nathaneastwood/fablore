...
Renamed the Nebula Blade, Lord Sutcliffe engraved the blade with conductive and focusing runes, which allow the Arknight to channel power through the shaft to form a blade of pure aether. The runes have corrupted the blade's original purpose, and as [Viserai](https://legendarystories.net/heroes-of-rathe/viserai-about.html) learned to wield the Nebula Blade, the power of the Arknight shard seeped into the crystal embedded in the pommel, staining it a deep, dark purple.
